...
$query = "SELECT rol_id FROM usuarios WHERE idusuario = ?";
...
$query = "SELECT idusuario, nombre, email, rol_id FROM usuarios";
...
<head>
    ...
    <style>
        ...
        .btn_crear {
            background-color:rgb(37, 196, 98); /* Color rojo sandía */
            color: white;
            font-size: 16px;
            padding: 12px 24px;
            border: none;
        ...
        .btn_crear:hover {
            background-color:rgb(53, 248, 46); /*al pasar el cursor */
        }
        ...
        <table class="table table-dark table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="editar_usuario.php?id=<?php echo $row['idusuario']; ?>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="eliminar_usuario.php?id=<?php echo $row['idusuario']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar este usuario?');">Eliminar</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
