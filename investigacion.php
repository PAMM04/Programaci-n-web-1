...
// Consultar las noticias de la categoría "Investigación" (ID 2)
$queryInvestigacion = "SELECT * FROM noticias WHERE categoria_id = 2";
$resultInvestigacion = $conexion->query($queryInvestigacion);

// Verificar si hay noticias disponibles
if (!$resultInvestigacion) {
    die("Error al obtener noticias de investigación: " . $conexion->error);
}
?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a class="nav-link active" href="investigacion.php">Investigación</a></li>
...
<div class="container mt-5">
    <h1 class="mb-4">Noticias de Investigación</h1>

    <?php if ($resultInvestigacion->num_rows > 0): ?>
        <div class="row">
            <?php while ($noticia = $resultInvestigacion->fetch_assoc()): ?>
                <div class="col-md-4">
                    <div class="card">
    ...
    <?php else: ?>
        <div class="alert alert-warning">No hay noticias disponibles en la categoría de investigación.</div>
    <?php endif; ?>
</div>
