...
// Consultar las noticias de la categoría "Convenios" (ID 4)
$queryConvenios = "SELECT * FROM noticias WHERE categoria_id = 4";
$resultConvenios = $conexion->query($queryConvenios);

// Verificar si hay noticias disponibles
if (!$resultConvenios) {
    die("Error al obtener noticias de convenios: " . $conexion->error);
}
?>
...
<head>
    ...
    <title>Noticias - Convenios</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a class="nav-link active" href="convenios.php">Convenios</a></li>
        </ul>
    </div>
</nav>

<div class="container mt-5">
    <h1 class="mb-4">Noticias de Convenios</h1>

    <?php if ($resultConvenios->num_rows > 0): ?>
        <div class="row">
            <?php while ($noticia = $resultConvenios->fetch_assoc()): ?>
                <div class="col-md-4">
                    <div class="card">
    ...
    <?php else: ?>
        <div class="alert alert-warning">No hay noticias disponibles en la categoría de convenios.</div>
    <?php endif; ?>
</div>
